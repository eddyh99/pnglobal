        ...
        <div class="row content-body">
            <div class="col-lg-12">
                ...
                <div class="row statistics-cards mb-4">
                    ...
                    <div class="col-md-6">
                        <div class="custom-card right-card <?= ($day_remaining < 30) ? 'warning-card' : '' ?>">
                            <div class="card-row card-top <?= ($day_remaining < 30) ? 'warning-text' : '' ?>">
                                Account Status : Active until <?= date('d-m-Y', strtotime($end_date)) ?>
                            </div>
                            <div class="card-row card-bottom d-flex justify-content-between align-items-center">
                                <div class="left-column <?= ($day_remaining < 30) ? 'warning-days blink' : '' ?>">
