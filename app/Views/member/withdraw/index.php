        ...
        <div class="row content-body">
            ...
            <div class="withdraw-options">
                ...
                <div class="withdraw-buttons">
                    <button class="transfer-btn">USA Local Bank Transfer</button>
                    <button class="transfer-btn">USDT</button>
                    <button class="transfer-btn">International Bank Transfer</button>
                    <button class="transfer-btn">USDC</button>
                </div>
            </div>
