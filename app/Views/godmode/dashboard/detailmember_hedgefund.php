                    ...
                    <div class="d-flex" style="gap: 1rem;">
                        <div class="card rounded" style="width: 18rem;background-color: #bfa573;">
                            <div class="card-body p-2">
                                ...
                                <h2 class="text-right text-black"><?= '$ ' . @number_format($member->fund_usdt ?? 0, 2, '.', ',') ?></h2>
                            </div>
                        </div>
                        <div class="card rounded" style="width: 18rem;background-color: #bfa573;">
                            <div class="card-body p-2">
                                ...
                                <h2 class="text-right text-black">
                                    ...
                                    <?= @number_format($member->fund_btc ?? 0, 6, '.', ',') ?>
                                </h2>
                            </div>
                        </div>
                        <div class="card rounded" style="width: 18rem;background-color: #bfa573;">
                            <div class="card-body p-2">
                                <h5 class="card-title text-black mb-0 fw-bold">USDT </h5>
                                <h2 class="text-right text-black"><?= '$ ' . @number_format($member->trade_usdt ?? 0, 2, '.', ',') ?></h2>
                            </div>
                        </div>
                        <div class="card rounded" style="width: 18rem;background-color: #bfa573;">
                            <div class="card-body p-2">
                                ...
                                <h2 class="text-right text-black">
                                    ...
                                    <?= @number_format($member->trade_btc ?? 0, 6, '.', ',') ?>
                                </h2>
                            </div>
                        </div>
                    </div>
