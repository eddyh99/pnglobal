...
<div class="content-page mb-5">
    <div class="container-fluid">
        ...
        <div id="satoshi-signal" class="tab-content active">
            <div class="row content-body">
                <div class="col-lg-12 px-2">
                    <div class="dash-statistics">
                        <a href="<?= BASE_URL ?>godmode/dashboard/satoshi" class="statistics">
                            <div class="iq-card">
                        ...
                        <a href="<?= BASE_URL ?>godmode/dashboard/satoshi?type=<?= base64_encode("free_member") ?>" class="statistics">
                            <div class="iq-card">
                                <div class="iq-card-body">
                                    <div class="d-flex flex-column justify-content-center align-items-start">
                                        <div>
