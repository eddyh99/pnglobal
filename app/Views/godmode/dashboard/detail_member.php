        ...
        <div class="row content-body">
            <div class="col-lg-12">
                <?php if ($tab === 'satoshi-signal') { ?>
                    <a class="text-white" href="<?= BASE_URL ?>godmode/dashboard?tab=satoshi-signal">BACK</a>
                <?php } else { ?>
            ...
            <div class="col-lg-10 mx-auto">
                ...
                <div class="dash-detailmember">
                    ...
                    <div class="value">
                        <?php
                        if ($tab === 'satoshi-signal') {
                            if ($member->message->role == "member") {
                                if ($member->message->free_status != 'yes') {
                                    echo "Normal Member";
                                } else {
                                    echo "Free Member";
                                }
                            } else if ($member->message->role == "referral") {
                                echo "Referral Member";
                            }
                        } else {
                    ...
                    <div class="value">
                        <?php
                        $dateString = $tab === 'satoshi-signal'
                            ? $member->message->start_date ?? ''
                            : $member->message->start_date ?? '';
                    ...
                    <div class="value">
                        <?php
                        if ($tab === 'satoshi-signal') {
                            echo $member->message->membership ?? 'N/A';
                        } else {
                            echo $member->message->subscription_status ?? 'N/A';
                        }
                        ?>
                    </div>
                    ...
                    <div class="value">
                        <?php
                        if ($tab === 'satoshi-signal') {
                            $totalDays = (int)$member->message->total_period;
                    ...
                    <div class="value">
                        ...
                        if ($tab === 'satoshi-signal') {
                            ...
                            echo $member->message->role=="referral" ? $member->message->refcode :  'N/A';
                        }
                        ?>
                    </div>
