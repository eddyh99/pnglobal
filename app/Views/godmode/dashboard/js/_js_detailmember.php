...
<script>
    let changeUplineModal;

    document.getElementById("btnChangeUpline").addEventListener("click", function() {
        const modalEl = document.getElementById('changeUplineModal');
        changeUplineModal = new bootstrap.Modal(modalEl);
        changeUplineModal.show();
    });

    document.getElementById("btnCancelUpline").addEventListener("click", function() {
        if (changeUplineModal) {
            changeUplineModal.hide();
        }
    });
</script>