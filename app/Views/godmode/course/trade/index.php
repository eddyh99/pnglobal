    ...
    <div class="container-fluid">
        <div class="flex-grow-1 p-4 text-center">
            <div class="container">
                ...
                <div class="d-flex">
                    <a href="<?= BASE_URL ?>godmode/course/user/member" class="btn mb-5"><i><svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-lg-12 dash-table-referralmember mt-4">
                    <table id="tbl_freemember" class="table table-striped p-2" style="width:100%">
