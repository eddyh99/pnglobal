                    ...
                    <div class="tutorial-steps">
                        <div class="tutorial-step">
                            ...
                            <div class="tutorial-image">
                                <img src="/assets/img/mobile-login.png" alt="Mobile Login">
                            </div>
                        </div>
                        ...
                        <div class="tutorial-step">
                            ...
                            <div class="tutorial-image">
                                <img src="/assets/img/api-mobile.png" alt="Desktop Search Bar">
                            </div>
                        </div>
                        ...
                        <div class="tutorial-step">
                            ...
                            <div class="tutorial-image">
                                <img src="/assets/img/create-api-mobile.png" alt="Desktop Search Bar">
                            </div>
                        </div>
                        ...
                        <div class="tutorial-step">
                            ...
                            <div class="tutorial-image">
                                <img src="/assets/img/mobile-system-generated.png" alt="Desktop Search Bar">
                            </div>
                        </div>
                        ...
                        <div class="tutorial-step">
                            ...
                            <div class="tutorial-image">
                                <img src="/assets/img/name-api.png" alt="Desktop Search Bar">
                            </div>
                        </div>

                        <div class="tutorial-step">
                            <h3>8. Complete the <span class="highlight">"Security Verification Requirements"</span> process.</h3>
                            <div class="tutorial-image">
                                <img src="/assets/img/mobile-restrictions.png" alt="Desktop Search Bar">
                            </div>
                        </div>

                        <div class="tutorial-step">
                            <h3>9. Once the API is created, click <span class="highlight">"Edit Restrictions"</span>.</h3>
                            <div class="tutorial-image">
                                <img src="/assets/img/mobile-edit-restriction.png" alt="Desktop Search Bar">
                            </div>
                        </div>

                        <div class="tutorial-step">
                            <h3>10. Check the box for <span class="highlight">"Enable Spot & Margin Trading"</span>.</h3>
                            <h3>11. Click <span class="highlight">"Save"</span>.</h3>
                            <div class="tutorial-image">
                                <img src="/assets/img/mobile-enable-spot.png" alt="Desktop Search Bar">
                            </div>
                        </div>

                        <div class="tutorial-step">
                            <h3>12. Complete the <span class="highlight">"Security Verification Requirements"</span> process.</h3>
                            <div class="tutorial-image">
                                <img src="/assets/img/mobile-security-verification.png" alt="Desktop Search Bar">
                            </div>
                        </div>
