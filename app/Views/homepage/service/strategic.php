...
<div class="banner-service">
    <div class="wrapper-service">
        ...
        <div class="banner-text-video">
            <div class="bg-text-video strategic">
                <h2 class="f-lato">
                    Strategic <br>
...
<section class="service">
    ...
    <section id="g-aid-reallocating-funds" class="wrapper-box-service">
        ...
        <div class="wrapper-img-absolute left">
            <img class="img-plane-dollar "src="<?= BASE_URL ?>assets/img/img-11.webp" alt="img plane dollar">
            <img class="img-plane-dollar" src="<?= BASE_URL ?>assets/img/img-11.webp" alt="img plane dollar">
        </div>
    </section>
    ...
    <!-- Service 4 -->
    <section id="g-tax-regulatory" class="wrapper-box-service">
        <div class="box-service brown-strategic left">
            <div class="container">
                <div class="row row-cols-1 row-cols-lg-2">
                    <div class="col wrapping-title">
                        <h3 class="box-content-title f-odor">
        ...
        <div class="wrapper-img-absolute left">
            <img class="img-plane-dollar "src="<?= BASE_URL ?>assets/img/img-27.webp" alt="img plane dollar">
            <img class="img-plane-dollar" src="<?= BASE_URL ?>assets/img/img-27.webp" alt="img plane dollar">
        </div>
    </section>
