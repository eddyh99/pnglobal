<div class="page-wrapper">
    <!-- Start of Banner -->
    <div class="banner-btcelite">
        <div class="wrapper-banner-btcelite">
            <video autoplay="" preload="" muted="" loop="" playsinline="">
                <source src="<?= BASE_URL ?>assets/vid/bg-btc-elite.mp4" type="video/webm">
            </video>
            <div class="logo-banner">
                <div class="text-wrapper">
                    <p class="logo-text-banner">
                        <span class="goal-text">
                            <span class="elite">BTC ELITE</span>
