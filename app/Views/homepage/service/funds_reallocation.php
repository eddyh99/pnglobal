<div class="page-wrapper">
    <section class="funds-reallocation">
        <div class="container-fluid p-0">
            <div class="row g-0">
                <!-- Left Column with Image -->
                <div class="col-12 col-lg-6">
                    <div class="fr-image">
                        <img src="<?= BASE_URL ?>assets/img/ic_funds_reallocation.png" alt="Funds Reallocation" class="img-fluid">
                    </div>
                </div>
                <!-- Right Column with Text Content -->
                <div class="col-12 col-lg-6">
                    <div class="fr-content">
                        <h1 class="fr-title">FUNDS REALLOCATION</h1>
                        <h2 class="fr-subtitle">Relocate Funds, Amplify Growth</h2>
                        <p class="fr-description">
                            Due to increasing regulations on international bank transfers, PN Global experts provide a risk-free, 100% legal solution through top banking partners. Your funds are relocated between jurisdictions via secure credit transfers.
                        </p>
                        <button class="fr-button">
                            Move Your Capital <br>
