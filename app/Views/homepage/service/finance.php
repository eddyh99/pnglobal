...
<main class="pt-5" style="overflow-x: hidden;">
    ...
    <!-- Start of Win -->
    <section style="background-color: #D3C19E;">
    ...
    <!-- Start of Service -->
        <section class="finance-service">

        <!-- Service 1 -->
        <div class="finance-service-one box-service p-0 m-0 bg-transparent">
            <div class="container">
                <div class="row position-relative ">
                    <div class="col-12 col-lg-7 ">
                        <img class="img-fluid img-servicer-one position-relative" src="<?= BASE_URL ?>assets/img/img-8.webp" alt="img">
                    </div>
                    <div class="col-12 col-lg-5 d-flex my-6">
                        <p class="text-service-one f-notoserif">
                            We are here to provide you with efficient financial advice and help you plan your future with wisdom and accuracy. Whether it’s tailored financial advice or targeted investment advice, our commitment is to guide you towards financial success. You can count on PN Global to safeguard your financial future.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <!-- Service 2 -->
            <div class="box-service black ms-3 ms-md-10">
            <div class="container">
                <div class="row p-4">
                    ...
                    <div id="finance-advice-text" class="order-2 order-lg-1 col-12 col-lg-5 box-content">
                        ...
                        <h5 class="box-content-subtitle f-notoserif">
                            Manage your finances with wisdom and precision
                        </h5>
                        <p class="box-content-text f-inter pt-4">
            ...
            <div class="container">
                <div class="row p-4">
                    <div id="finance-winning-text" class="order-2 order-lg-1 col-12 col-lg-5 box-content gray-trans">
                        ...
                        <h5 class="box-content-subtitle f-notoserif" style="color: #6A625B;">
                            Invest in the Future with Awareness
                        </h5>
                        <p class="box-content-text f-inter pt-4" style="color: #6A625B;">
