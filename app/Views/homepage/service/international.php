...
<section class="service mb-0">
    ...
    <section id="g-expansion-more" class="wrapper-box-service">
        ...
        <div class="wrapper-img-absolute left">
            <img class="img-expansion-international" src="<?= BASE_URL ?>assets/img/img-14.webp" alt="Expansion in more favorable Jurisdictions">
            <img class="img-expansion-international" src="<?= BASE_URL ?>assets/img/img-14.webp" alt="Expansion in more favorable Jurisdictions">
        </div>
    </section>
    ...
    <!-- Service 2 -->
    <section id="g-visa-international" class="wrapper-box-service">
        <div class="box-service black-international right">
            <div class="container">
                <div class="row row-cols-1 row-cols-lg-2">
        ...
        <div class="wrapper-img-absolute right">
            <img class="img-visa-international "src="<?= BASE_URL ?>assets/img/img-15.webp" alt="Consulting for Visas and Residence Permits">
            <img class="img-visa-international" src="<?= BASE_URL ?>assets/img/img-15.webp" alt="Consulting for Visas and Residence Permits">
        </div>
    </section>

    <!-- Service 3 -->
    <section id="g-consulting-offshore" class="wrapper-box-service">
        <div class="box-service brownis-international left">
            <div class="container">
                <div class="row row-cols-1 row-cols-lg-2">
                    <div class="col wrapping-title">
                        <h3 class="box-content-title f-odor">
        ...
        <div class="wrapper-img-absolute left">
            <img class="img-expansion-international" src="<?= BASE_URL ?>assets/img/img-16.webp" alt="Consulting for Offshore Bank Account Setup">
            <img class="img-expansion-international" src="<?= BASE_URL ?>assets/img/img-16.webp" alt="Consulting for Offshore Bank Account Setup">
        </div>
    </section>
