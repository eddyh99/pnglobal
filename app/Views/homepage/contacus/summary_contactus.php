    ...
    <div class="row">
        <div class="col-4 d-none d-lg-block bg-contact-wrap position-relative">
            <div class="bg-contact">
                <div class="h-100 w-50 mx-auto text-white d-flex justify-content-center align-items-center">
                    <img class="img-fluid" src="<?= base_url()?>assets/img/big-logo.png" alt="logo">                
                </div>
