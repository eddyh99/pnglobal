...
<div class="d-flex flex-column mx-3 my-2 text-center" style="height: 100vh;">
    ...
    <div class="d-flex justify-content-between mx-3">
        <div class="d-flex">
            <button class="btn p-0 px-2 d-flex flex-column align-items-center" disabled><i>
            ...
            <button id="raisehand" class="btn p-0 px-2 d-flex flex-column align-items-center"><i>
        ...
        <button id="btnleave" class="btn p-0"><i>
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
