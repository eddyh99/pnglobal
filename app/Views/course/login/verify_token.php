        ...
        <div class="row p-0 m-0">
            <div class="col-12 p-0 m-0">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <div class="position-relative otp-area w-100 shadow-none" style="background-color: transparent;">
                        ...
                        <?php } ?>
                        <form id="satoshi-otp-form" method="POST" action="<?= BASE_URL ?>course/auth/reset_password_confirmation" onsubmit="setFormData()" class="p-3 text-center">
                            <h5 class="text-white">Check Your Email To Get OTP</h5>
                            <br>
                            ...
                            <h6 class="text-white">Enter the activation code in the column provided.</h6>
