        ...
        "columns": [{
            ...
            },
            {
                ...
                "mRender": function(data, type, full, meta) {
                    const btnplay = `<a href="<?= BASE_URL ?>course/mentor/live/host?room_id=${full.roomid}" target="__blank"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="20" viewBox="0 0 30 20" fill="none">
