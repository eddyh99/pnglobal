...
<div class="iq-sidebar">
    ...
    <div class="iq-sidebar-logo d-flex justify-content-between align-items-center">
        <a href="<?= BASE_URL ?>elite/dashboard" class="header-logo">
        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="<?= @$active_dash ?>">
                    <a href="<?= BASE_URL ?>elite/dashboard" class="iq-waves-effect">
                        <i>
                ...
                <li class="<?= @$active_referral ?>">
                    <a href="<?= BASE_URL ?>elite/referral" class="iq-waves-effect">
                        <i>
                ...
                // if ($_SESSION["logged_user"]->role=="admin"){
                ?>
                <li class="<?= @$active_deposit ?>">
                    <a href="<?= BASE_URL ?>elite/deposit" class="iq-waves-effect">
                        <i>
                            <svg xmlns="http://www.w3.org/2000/svg" width="33" height="30" viewBox="0 0 512 512" fill="<?= (@$active_deposit != null) ? 'black' : 'white' ?>">
                        ...
                        <span class="<?= (@$active_deposit != null) ? 'text-black' : 'text-white' ?>">Deposit</span>
                    </a>
                </li>
                <!-- <li class="<?= @$active_membership ?>">
                    <a href="<?= BASE_URL ?>elite/membership" class="iq-waves-effect">
                        <i>
                ...
                ?>
                <li>
                    <a href="<?= BASE_URL ?>elite/auth/logout" class="iq-waves-effect">
                        <i>
