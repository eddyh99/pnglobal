<script>
    ...
    $(document).ready(function() {
        ...
        function showSuccessAndRedirect(message) {
            // Gunakan modal yang sudah ada (usdtSuccessModal)
            $("#usdtSuccessModal .modal-body").html(`
        ...
        function showErrorMessage(message) {
            // Gunakan modal yang sudah ada (usdtSuccessModal) tapi dengan konten error
            $("#usdtSuccessModal .modal-body").html(`
                <div class="text-center">
                    <div class="mb-4">
                        <i class="ri-error-warning-line text-danger" style="font-size: 4rem;"></i>
                    </div>
                    <div>${message || '<p>An error occurred while processing your USDT payment.</p>'}</div>
                </div>
            `);
        ...
        // Handle form submission untuk konfirmasi pembayaran USDT
        $("#usdt-payment-form").on("submit", function(e) {
            e.preventDefault();
