    ...
    <div class="container">
        ...
        <div class="sign-in-box text-center p-4">
            ...
            <div class="d-flex flex-column justify-content-center align-items-center" style="height: 350px;">
                <a href="<?= BASE_URL ?>elite/auth/usdt_payment" class="btn btn-primary btn-lg w-75">USDT</a>
                <a href="<?= BASE_URL ?>elite/auth/usdc_payment" class="btn btn-primary btn-lg w-75 mt-3">USDC</a>
            </div>
        </div>
    </div>
</section>
