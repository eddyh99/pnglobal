    ...
    <div class="container-fluid d-flex justify-content-center align-items-center" style="min-height: 100vh;">
        <div class="card shadow p-4" style="background-color: #2c2c2c; color: white; border-radius: 12px; width: 100%; max-width: 500px;">
            ...
            <div class="d-flex flex-column justify-content-center align-items-center" style="height: 350px;">
                <a href="<?= BASE_URL ?>elite/deposit/usdt_payment" class="btn btn-primary btn-lg w-75 btn-withdraw">USDT</a>
                <a href="<?= BASE_URL ?>elite/deposit/usdc_payment" class="btn btn-primary btn-lg w-75 btn-withdraw mt-3">USDC</a>
            </div>
        </div>
    </div>
</div>
